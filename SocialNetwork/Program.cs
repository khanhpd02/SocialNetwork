...
// add services to DI container
{
    ...
    services.AddCors(options =>
    {
        options.AddPolicy("CorsPolicy",
            builder => builder
                .WithOrigins("https://font-socialk-network.vercel.app", "https://front-tlcn.vercel.app", "http://localhost:3000", "http://localhost:8081", "https://front-social-network-zeta.vercel.app", "https://socialnetworkadmin.vercel.app") // Add your frontend origin(s) here
                .AllowAnyMethod()
                .AllowAnyHeader()
                .AllowCredentials());
    });
