...
namespace SocialNetwork.Socket
{
    ...
    public class ChatHub : Hub
    {
        ...
        private readonly IUserService _userService;
        public ChatHub(SocialNetworkContext context, IMapper mapper, IUserService userService)
        {
            _context = context;
            _mapper = mapper;
            _userService = userService;
        ...
        {
            get { return _userService.UserEmail; }
        }
        ...
        public async Task SendUser(string message)
        {
            // Broadcast the message to all connected clients
            await Clients.All.SendAsync("ReceiveMessage", "CCCC Đã nhận");
        }
    }
}
